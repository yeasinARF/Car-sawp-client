                    ...
                    (currentUser === 'seller' || currentUser === 'admin') ? <>
                        {
                            currentUser === 'seller' && <>
                                <Card className='p-2 card mb-3 cardProduct w-100 ps-5 py-3' style={{ boxShadow: "2px 2px 10px 4px rgb(211, 211, 211)", backgroundColor: "rgb(227, 227, 227)", border: 'none' }}>
                                    ...
                                    < NavLink style={({ isActive }) => isActive ? { color: 'white', backgroundColor: 'rgb(107, 67, 251) ', textDecoration: 'none', paddingLeft: '10px', paddingTop: '15px', lineHeight: '8px', marginBottom: '10px', width: '200px', borderRadius: '5px', paddingRight:'15px'} : { paddingLeft: '10px', color: 'blue', textDecoration: 'none' }} className='fw-bold pb-3' to='profile'><img className=' rounded ' src={profile} alt="" style={{ height: '25px', width: '25px', marginTop: '-5px', marginRight: '8px',fontWeight:'bolder' }} />My Profile</NavLink>
