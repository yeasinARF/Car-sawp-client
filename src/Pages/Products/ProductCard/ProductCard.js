...
const ProductCard = ({ data, category }) => {
    const { name, img, location, resale_price, original_price, years_of_use, seller_name, _id, time, status, condition, seller_image, stockQuantity } = data;
    ...
    return (
        <Col md={6} lg={4}>
            <Card className='p-3 card mb-4 cardProduct ' style={{ boxShadow: "2px 2px 10px 4px rgb(211, 211, 211)", backgroundColor: "rgb(227, 227, 227)", border: 'none' }}>
                ...
                <Card.Body>
                    ...
                    <h6>
                        ...
                        <p className=''>Stock Quantity: {stockQuantity}</p>
                        <div>
